...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20191015-debates">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20191015-debates/",
      "url": "http://static.startribune.com/news/projects-staging/all/20191015-debates/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20191015-debates/",
      "url": "http://static.startribune.com/news/projects/all/20191015-debates/"
    }
  }
}
```
